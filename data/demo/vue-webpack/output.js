{
  mode: 'development',
  context: '/Users/liuguilian/Project/tuffy-home',
  ...
  output: {
    path: '/Users/liuguilian/Project/tuffy-home/dist',
    filename: '[name].js',
    publicPath: '/',
    globalObject: 'this'
  },
  resolve: {
    alias: {
      '@': '/Users/liuguilian/Project/tuffy-home/src',
      ...
      /* config.module.rule('vue') */
      {
        ...
        use: [
          /* config.module.rule('vue').use('cache-loader') */
          {
            loader: 'cache-loader',
            options: {
              cacheDirectory: '/Users/liuguilian/Project/tuffy-home/node_modules/.cache/vue-loader',
      ...
      /* config.module.rule('js') */
      {
        ...
        use: [
          /* config.module.rule('js').use('cache-loader') */
          {
            loader: 'cache-loader',
            options: {
              cacheDirectory: '/Users/liuguilian/Project/tuffy-home/node_modules/.cache/babel-loader',
              cacheIdentifier: '31e275bd'
            }
          },
      ...
      /* config.module.rule('ts') */
      {
        ...
        use: [
          /* config.module.rule('ts').use('cache-loader') */
          {
            loader: 'cache-loader',
            options: {
              cacheDirectory: '/Users/liuguilian/Project/tuffy-home/node_modules/.cache/ts-loader',
              cacheIdentifier: '7076e7ce'
            }
          },
  ...
  plugins: [
    ...
    new HtmlWebpackPlugin(
      {
        ...
        template: '/Users/liuguilian/Project/tuffy-home/public/index.html'
      }
    ),
    /* config.plugin('pwa') */
    new HtmlPwaPlugin(
    ...
    new CopyWebpackPlugin(
      [
        {
          from: '/Users/liuguilian/Project/tuffy-home/public',
          to: '/Users/liuguilian/Project/tuffy-home/dist',
          toType: 'dir',
          ignore: [
            '.DS_Store'
          ]
